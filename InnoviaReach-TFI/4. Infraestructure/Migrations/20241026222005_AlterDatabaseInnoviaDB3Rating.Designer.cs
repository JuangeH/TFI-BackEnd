...
namespace _4._Infraestructure.Migrations
{
    ...
    [Migration("20241026222005_AlterDatabaseInnoviaDB3Rating")]
    partial class AlterDatabaseInnoviaDB3Rating
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Models.RatingModel", b =>
                {
                    ...
                    b.Property<int?>("VideojuegoModelVideojuego_ID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VideojuegoModelVideojuego_ID");
            ...
            modelBuilder.Entity("Core.Domain.Models.VideojuegoPlataformaModel", b =>
                {
                    ...
                    b.Property<int?>("Videojuego_ID1")
                        .HasColumnType("int");

                    b.Property<int?>("plataformaModelPlataforma_ID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("Videojuego_ID1");

                    b.HasIndex("plataformaModelPlataforma_ID");

                    b.ToTable("VideojuegoPlataformaModel");
                });
            ...
            modelBuilder.Entity("Core.Domain.Models.RatingModel", b =>
                {
                    b.HasOne("Core.Domain.Models.VideojuegoModel", null)
                        .WithMany("ratingModels")
                        .HasForeignKey("VideojuegoModelVideojuego_ID");
                });
            ...
            modelBuilder.Entity("Core.Domain.Models.VideojuegoPlataformaModel", b =>
                {
                    b.HasOne("Core.Domain.Models.VideojuegoModel", "videojuego")
                        ...
                        .HasForeignKey("Videojuego_ID1");

                    b.HasOne("Core.Domain.Models.PlataformaModel", "plataformaModel")
                        .WithMany("videojuegoPlataformaModels")
                        .HasForeignKey("plataformaModelPlataforma_ID");
